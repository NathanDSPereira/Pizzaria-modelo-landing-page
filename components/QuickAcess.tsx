        ...
        <section className="bg-zinc-950 py-8 px-4 space-y-6">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-row justify-center items-center md:justify-center gap-3 md:gap-6 mt-4">
                    ...
                    <button className="hover:cursor-pointer hover:border-amber-500 flex justify-center items-center w-44 h-16 bg-zinc-900/50 border border-zinc-800 text-zinc-300 py-3 rounded-2xl text-sm font-medium active:scale-95 transition-all active:border-amber-500">
                        <Image 
            ...
            <div className={`fixed bottom-6 left-0 right-0 z-50 px-4 transition-all duration-300 flex justify-center ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
                <button className="w-full bg-amber-600 text-zinc-950 font-bold mx-auto md:max-w-100 md:px-12 md:py-4 h-14 rounded-2xl shadow-lg active:scale-95 transition-all">
                🍕 FAZER PEDIDO AGORA
                </button>
            </div>
        </section>
