        ...
        <section className="flex flex-col justify-center items-center mb-2">
            ...
            <div className="w-72  bg-zinc-900/90 backdrop-blur-sm rounded-xl flex flex-col gap-4 shadow-lg">
                ...
                <div className="flex flex-col gap-3 pb-6">
                    ...
                    <button className="bg-zinc-700/50 border hover:cursor-pointer hover:border-amber-500 border-zinc-800 text-zinc-300 py-3 mx-4 rounded-xl text-md font-semibold active:scale-95 transition-all active:border-amber-500 flex items-center gap-2 justify-center">
                        Como chegar
